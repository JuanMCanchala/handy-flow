...
pub struct AppSettings {
    ...
    #[serde(default = "default_voice_edits_enabled")]
...
fn default_voice_edits_enabled() -> bool {
    true
}
...
decisions made, and a \"## Action Items\" section.".to_string(),
        },
        NoteTemplate {
...
section for any follow-ups either person committed to.".to_string(),
        },
        NoteTemplate {
...
section, a \"## Concerns\" section, and a \"## Action Items\" section for next steps.".to_string(),
        },
        NoteTemplate {
...
follow-up reading mentioned.".to_string(),
        },
    ]
}
...
pub fn get_default_settings() -> AppSettings {
    ...
    AppSettings {
        ...
        voice_edits_enabled: default_voice_edits_enabled(),
