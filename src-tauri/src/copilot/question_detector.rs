...
const EN_INTERROGATIVE_STARTS: &[&str] = &[
    "what", "why", "how", "when", "where", "who", "whom", "whose", "which", "do", "does", "did",
    "is", "are", "was", "were", "can", "could", "will", "would", "should", "have", "has", "had",
];
...
const ES_INTERROGATIVE_STARTS: &[&str] = &[
    "que", "por que", "porque", "como", "cuando", "donde", "quien", "quienes", "cual", "cuales",
