...
const ModesSettings = lazy(() =>
  import("./settings/modes/ModesSettings").then((m) => ({
    default: m.ModesSettings,
  })),
);
const TemplatesSettings = lazy(() =>
  import("./settings/templates/TemplatesSettings").then((m) => ({
    default: m.TemplatesSettings,
  })),
);
