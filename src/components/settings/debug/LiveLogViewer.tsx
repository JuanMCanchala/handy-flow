  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-2 gap-2">
        <div className="flex items-center gap-2 text-caption text-text-tertiary min-w-0">
          <span
            className={`inline-block w-2 h-2 rounded-full shrink-0 ${
              paused ? "bg-text-tertiary" : "bg-success animate-pulse"
            }`}
          />
      ...
      <div
        ...
        className="h-72 overflow-y-auto rounded-lg border border-border bg-surface-sunken p-3 font-mono text-caption leading-relaxed select-text"
      >
        {logs.length === 0 ? (
          ...
          logs.map((line) => {
            ...
            return (
              <div key={line.id} className="flex gap-2">
                <span className="text-text-tertiary shrink-0 select-none tabular">
                  {line.time}
                </span>
                <span
